...
export const mockDepartments: Department[] = [
  {
    ...
    code: 'ENG',
    head: 'Sanjay Kumar',
    contactEmail: 'engineering@citytrace.gov.in',
  ...
  },
  {
    ...
    code: 'SAN',
    head: 'Meera Reddy',
    contactEmail: 'sanitation@citytrace.gov.in',
  ...
  },
  {
    ...
    code: 'ELEC',
    head: 'Rajesh Singh',
    contactEmail: 'electrical@citytrace.gov.in',
  ...
  },
  {
    ...
    code: 'WTR',
    head: 'Anita Desai',
    contactEmail: 'water@citytrace.gov.in',
  ...
  },
  {
    ...
    code: 'RDS',
    head: 'Vivek Sharma',
    contactEmail: 'roads@citytrace.gov.in',
