...
begin
  ...
  if new.status = 'accepted' then
    ...
    /*
     * Reassignment. The previous officer's acceptance and start times
     * describe work this assignee has not done, and leaving them would
     * put an "Accepted" entry on the timeline dated before they were
     * given the job. The audit trail keeps the history; these four
     * columns describe the current assignment only.
     */
